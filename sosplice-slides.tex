...
\path (fd) +(0,.6) coordinate (fdx) {};
\path (node cs:name=fd,anchor=west) +(.3,.3) coordinate (fdo) {};
\path (node cs:name=rd,anchor=west) +(.3,-.3) coordinate (rdi) {};
\draw[->] (fdo) -- (fdo |- fdx) -| (rdi);
\path (node cs:name=fd,anchor=east) +(-.3,.3) coordinate (fdi) {};
\path (node cs:name=wr,anchor=west) +(.3,-.3) coordinate (wro) {};
\draw[->] (wro) -- (wro |- fdx) -| (fdi);
